...
from cs336_basics import bpe, tokenizer, opt, data
import torch
...
def run_rope(
    ...
    """
    rope = nn.RotaryPositionalEmbedding(theta, d_k, max_seq_len)
...
def run_rmsnorm(
    ...
    """
    rmsnorm = nn.RMSNorm(d_model, eps)
...
def run_softmax(in_features: Float[Tensor, " ..."], dim: int) -> Float[Tensor, " ..."]:
    ...
    """
    return nn.softmax(in_features, dim=dim)
...
def run_get_lr_cosine_schedule(
    ...
    """
    return opt.learning_rate_schedule(it, max_learning_rate, min_learning_rate, warmup_iters, cosine_cycle_iters)
